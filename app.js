...
const monthlyData = {
  ...
  "李孟馨": [
    { content: "目前缺口在RS，但用HA補。台大近一年HA潛客名單", target: "每周聯繫 5 個 (周二台大 RS 駐點 13:00~13:30 較有空檔)" },
    { content: "聯繫台大歷年舊客 (有效、高階、過保)，優先邀約回站前店", target: "共 57 位名單，日均致電約 4 位" }
  ],
  "劉瑋婷": [
    { content: "金山南潛客名單（客編從 2024/06 往前，條件：住附近、潛客），另請梅子姐過濾無效名單", target: "每日 5 通（在站前值班時完成），合計每週 10 通" }
  ],
  "周曉玄": [
  ...
  "蕭純聿": [
    { content: "提升舊客成交率：1. 以單一個案與教育訓練討論服務內容及新舊機差異展示方式；2. 秉忻確認舊客試聽服務影片後回饋優化建議", target: "舊客成交率 47% (區域門市平均)" },
    { content: "針對台大 2025 的 HA 潛客做追蹤（利用週五彈性時間）", target: "下次面談時完成 50% 的聯繫進度" }
  ],
  "陳宛妤": [
  ...
  "林寓葳": [
    { content: "篩選天母 6 個月以上未聽檢舊客名單邀約進店（進店送 5 點，帶友加送 5 點）", target: "4 月底前完成至少 10 個舊客聽檢" },
    { content: "整理 2015-2016 剩餘 HA 舊客名單（填寫類別與狀況）並開始聯繫 2025 年以前潛客", target: "每週聯繫 10 通有接通潛客，邀約 1 位回店" },
    { content: "針對 2025 年 RS 未成交的個案進行聯繫", target: "下次面談前確認進度" }
  ],
  "吳欣珮": [
